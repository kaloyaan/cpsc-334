...
String devices[DEVICE_COUNT] = {"94:B9:7E:FA:9B:84", "C8:C9:A3:F9:0C:A0", "94:B9:7E:F9:2D:1C"};
String names[DEVICE_COUNT] = {"Red", "Orange", "Yellow"};
String name;
const char* domains[DEVICE_COUNT] = {"https://red.cody.ws/", "https://orange.cody.ws/", "https://yellow.cody.ws/"};

int nearbyFlags[3] = {0, 0, 0};
        ...
        if (client.available()) {
          ...
          if (c == '\n') {
            ...
            if (currentLine.length() == 0) {
              ...
              client.println(nearbyFlags[0]);
              client.println(nearbyFlags[1]);
              client.println(nearbyFlags[2]);
